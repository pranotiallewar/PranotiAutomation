...
public class MouseAction3 {
	public static void main(String[] args) throws InterruptedException {
		...
		List<WebElement> source =driver.findElements(By.xpath("//li[@class='ui-widget-content ui-corner-tr ui-draggabl ui-raggable-handle']"));
		...
		{
			WebElement image = source.get(i); // get method is use to get value from list
